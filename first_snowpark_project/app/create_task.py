...
with DAG("my_dag", schedule=timedelta(days=1)) as dag:
    ...
    dag_task3 = DAGTask("my_test_task3", StoredProcedureCall(procedures.test_procedure_two, packages=["snowflake-snowpark-python"], imports=["@dev_deployment/my_snowpark_project/app.zip"], stage_location="@dev_deployment"), warehouse="compute_wh")

    dag_task4 = DAGTask("my_test_task4", StoredProcedureCall(procedures.test_procedure, packages=["snowflake-snowpark-python"], imports=["@dev_deployment/my_snowpark_project/app.zip"], stage_location="@dev_deployment"), warehouse="compute_wh")
